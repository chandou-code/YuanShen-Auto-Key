...
YuanShen Auto Key 是一个专为原神游戏设计的自动化按键工具。它能够自动监听原神游戏的启动和关闭，并在游戏运行时提供自动按键功能，帮助玩家简化重复性操作。
...
[![Star History Chart](https://api.star-history.com/svg?repos=your-username/yuanshen-auto-key&type=Date)](https://star-history.com/#your-username/yuanshen-auto-key&Date)
